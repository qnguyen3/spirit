...
define_settings_group!(CodeSettings, settings: [
    ...
    // Controls whether third-party CLI agent sessions appear in the right sidebar.
    show_agent_session_history: ShowAgentSessionHistory {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        surface: settings::SettingSurfaces::GUI,
        private: false,
        toml_path: "code.editor.show_agent_session_history",
        description: "Whether third-party CLI agent session history is shown in the right sidebar.",
    },
    agent_session_history_sort: AgentSessionHistorySort {
        type: String,
        default: "updated".to_owned(),
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
        surface: settings::SettingSurfaces::GUI,
        private: true,
    },
    agent_session_history_group: AgentSessionHistoryGroup {
        type: String,
    ...
    agent_session_history_limit: AgentSessionHistoryLimit {
        type: String,
        default: "250".to_owned(),
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
        surface: settings::SettingSurfaces::GUI,
        private: true,
    },
    agent_session_history_hide_empty: AgentSessionHistoryHideEmpty {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    agent_session_history_agents: AgentSessionHistoryAgents {
        type: String,
        default: "*".to_owned(),
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
