...
///
/// If the error is actionable, it is logged at the Error level; otherwise it is logged at the
/// Warn level.
#[macro_export]
macro_rules! report_error {
    ...
    // Reports `err` and appends the given fields to the local log line.
